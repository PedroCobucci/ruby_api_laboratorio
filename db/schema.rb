...
ActiveRecord::Schema[7.0].define(version: 2023_06_12_224026) do
  ...
  create_table "exames", force: :cascade do |t|
    ...
    t.index ["paciente_id"], name: "index_exames_on_paciente_id"
  end
  ...
  add_foreign_key "exames", "usuarios", column: "paciente_id", on_delete: :cascade
end
